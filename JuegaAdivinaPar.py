...
#Clase JuegaAdivinaPar la cual corresponde a a la importación JuegaAdivinaNumero, con sus respectivos atributos.
class JuegaAdivinaPar(JuegaAdivinaNumero):
    _numeroAdivinar = 0
    _vidas = 0
    _numero = 0
    ...
    def AdivinarNumero(self):
        ...
        print("Vamos!! Adivina un número par entre 0 y 10")
        ...
        while self._vidas != 0:
            ...
            self._numero = int(input("Introduce tu numero :3 : "))
        ...
        print ("El número par a adivinar era :" , self._numeroAdivinar, "\n")

#Apartado que sirve para poder realizar la ejecución de JuegaAdivinaPar
Juego = JuegaAdivinaPar((choice((2, 4, 6, 8, 10))),3)

#Identificación al segundo juego.
